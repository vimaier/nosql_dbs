...
public class UserDTO {
  ...
  public UserDTO(String forname, String surname, String mailadress, String street, String housenumber, String postcode,
      String city, String password, CommonsMultipartFile picture_up) {
    super();
  ...
  public String toString() {
    return "UserDTO [id=" + id + ", forname=" + forname + ", surname=" + surname + ", mailadress=" + mailadress
        + ", street=" + street + ", housenumber=" + housenumber + ", postcode=" + postcode + ", city=" + city
        + ", picture_up=" + picture_up + "]";
  }
  ...
  public boolean areAttributesEqual(UserDTO other) {
    ...
    if (this == other)
      return true;
    return mailadress.equals(other.getMailadress()) && forname.equals(other.getForname())
        && surname.equals(other.getSurname()) && street.equals(other.getStreet())
        && housenumber.equals(other.getHousenumber()) && postcode.equals(other.getPostcode())
        && city.equals(other.getCity()) && password.equals(other.getPassword());
