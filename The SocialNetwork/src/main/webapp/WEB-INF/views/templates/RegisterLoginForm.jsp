...
<div id="registerfade">
	...
	<sf:form action="Register.do" commandName="UserDTO">
		<div class="fl">
			<sf:label path="forname">
				<fmt:message key="registerform.forname" />
			</sf:label>
		</div>
		<div class="fr">
			<sf:input class="input_text" path="forname" />
		</div>
		<div class="clr"></div>
		<div class="fl">
		...
		<div class="fl">
			<div style="margin-left: 30px; margin-top: 20px;"
				class="rm fr button_grey registerclose">
				<fmt:message key="website.cancel" />
			</div>
		</div>
		<div class="fr">
			<sf:button style="margin-right: 30px; margin-top: 20px;"
				class="rm fr button_blue">
...
<div id="loginfade">
	...
	<sf:form action="Login.do" commandName="LoginDTO">
		...
		<div class="fl">
			<div style="margin-left: 30px; margin-top: 20px;"
				class="rm fr button_grey loginclose">
				<fmt:message key="website.cancel" />
			</div>
		</div>
		<div class="fr">
